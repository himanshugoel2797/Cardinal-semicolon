...
// Value returned by physmem_alloc when the request cannot be satisfied
...
uintptr_t physmem_alloc(int domain, int color, physmem_alloc_flags_t flags, size_t size);
