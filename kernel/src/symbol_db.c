...
void symboldb_init() {
  symbol_e_offsets = bootstrap_malloc(MAX_SYMBOL_CNT * sizeof(uint64_t));
  symbol_hdr_offsets = bootstrap_malloc(MAX_SYMBOL_CNT * sizeof(uint64_t));
  symbol_strhdr_offsets = bootstrap_malloc(MAX_SYMBOL_CNT * sizeof(uint64_t));
...
static int symboldb_addentry(uint32_t idx, Elf64_Shdr *strhdr, Elf64_Shdr *hdr, Elf64_Sym *sym) {
...
static int symboldb_entrymatch(uint32_t idx, Elf64_Shdr *strhdr, Elf64_Shdr *hdr, Elf64_Sym *sym,
...
int symboldb_findmatch(Elf64_Shdr *strhdr, Elf64_Shdr *hdr, Elf64_Sym *sym, Elf64_Shdr **r_hdr,
                       Elf64_Sym **r_sym) {
