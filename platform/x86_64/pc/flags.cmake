...
COMMAND grub2-mkrescue -d /usr/lib/grub/i386-pc -o "ISO/os.iso" "ISO/isodir"
DEPENDS kernel.bin)
...
add_custom_target(run 
    COMMAND qemu-system-x86_64 --enable-kvm -m 1024M -machine q35, -cpu host,+invtsc,+xsave,+aes -smp 1 -d int,cpu_reset,guest_errors -drive id=disk,file=disk.img,if=none -device ahci,id=ahci -device ide-drive,drive=disk,bus=ahci.0 -net nic,model=virtio, -net dump,file=../dump.pcap -net bridge,br=virbr0 -device ich9-intel-hda -device hda-output -device ich9-usb-uhci3 -cdrom "ISO/os.iso" -boot d -device virtio-vga,virgl=on -display gtk,gl=on
    DEPENDS image
    DEPENDS disk.img)