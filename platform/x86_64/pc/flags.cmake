...
add_custom_target(run 
    COMMAND qemu-system-x86_64 --enable-kvm -m 1024M -machine q35, -cpu host,+invtsc,+xsave,+aes -smp 1 -d int,cpu_reset,guest_errors -drive id=disk,file=disk.img,if=none -device ahci,id=ahci -device ide-drive,drive=disk,bus=ahci.0 -net nic,model=rtl8139, -net dump,file=../dump.pcap -net user -soundhw hda -device ich9-usb-uhci3 -device usb-mouse -device usb-kbd -device virtio-vga,virgl=on -cdrom "ISO/os.iso" -boot d -display gtk,gl=on
    DEPENDS image
    DEPENDS disk.img)